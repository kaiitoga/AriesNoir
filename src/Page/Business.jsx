...
/*
Commented out Business component - complete implementation preserved below:
...
//                     東京を拠点に、営業顧問サービスを通じて<br className="hidden sm:block" />
//                     企業の成長と繁栄をサポート
//                   </p>
//                 </div>
...
//                   <div className="group">
//                     <div className="text-3xl sm:text-4xl md:text-5xl font-black text-gray-900 group-hover:text-red-500 transition-colors">300+</div>
//                     <div className="text-xs sm:text-sm text-gray-500 uppercase tracking-wider mt-1">Companies</div>
//                   </div>
//                   <div className="group">
//                     <div className="text-3xl sm:text-4xl md:text-5xl font-black text-gray-900 group-hover:text-red-500 transition-colors">200%</div>
//                     <div className="text-xs sm:text-sm text-gray-500 uppercase tracking-wider mt-1">Sales Growth</div>
//                   </div>
//                   <div className="group">
//                     <div className="text-3xl sm:text-4xl md:text-5xl font-black text-gray-900 group-hover:text-red-500 transition-colors">15+</div>
//                     <div className="text-xs sm:text-sm text-gray-500 uppercase tracking-wider mt-1">Years Experience</div>
//                   </div>
//                 </div>
//               </div>
//             </div>
...
//                   東京都を拠点に、企業の営業力向上を支援する
//                   当社は東京都を拠点に、営業顧問として企業の売上向上と組織強化をサポートしています。
//                   <br />
//                   営業戦略の策定から現場での実践指導まで、企業に寄り添った伴走型のコンサルティングを提供しています。
//                   <br />
//                   これまで300社以上の企業をサポートし、平均して売上200%向上の実績を残しています。
//                 </p>
//               </div>
...
//                     当社は、業界で豊富な実績を築いています。実績豊富なチームが協力してプロジェクトに取り組むことで、確かな価値と信頼をお届けしています。
//                   </p>
//                 </div>
...
//               <iframe
//                 src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3241.7471478446146!2d139.70076931521!3d35.65879098019729!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x60188b5692719d7d%3A0x70515b76ecb9c99d!2z5riL6LC355qE54Gj5LiK6KW_X-OChOODs-ODs-OCreODs-ODkuODq-OCuOODo-ODq-OCpOODs--8iOODkeODiOODs-ODhuOCvOOCouODs-ODieODo-OCreOCueOBvOOCs-OBl-ODqeODleODn1wp!5e0!3m2!1sja!2sjp!4v1641234567890!5m2!1sja!2sjp"
//                 style={{ border: 0 }}
//                 allowFullScreen=""
//                 loading="lazy"
