  ...
  return (
    <section className="w-full px-8 py-16 lg:pt-36 bg-gray-900 overflow-hidden">
      <div className="flex flex-col lg:flex-row lg:items-start">
        <div className="order-1 lg:order-1 w-96 -mb-10 -ml-3  lg:w-[380px] lg:-mt-20 lg:-mr-24 xl:w-[430px] xl:-mr-20 xl:-mt-14 2xl:w-[600px] 2xl:-mr-24 2xl:-mt-28">
          <img className='w-max' src="../img/Home/rain.jpg" alt="" />
        </div>
        <div className="order-2 lg:order-2 bg-white px-4 py-8 max-w-2xl xl:max-w-4xl relative z-10 flex-shrink-0">
          <h2 className="font-bold text-2xl xl:text-3xl 2xl:text-4xl p-1 text-gray-900">
            地獄から這い上がった
